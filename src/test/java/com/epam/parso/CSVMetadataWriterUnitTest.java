...
public class CSVMetadataWriterUnitTest {
    ...
    public void testMetadata() {
        ...
        if (resourcesPath != null) {
            ...
            for (File currentFile : files) {
                ...
                sasFileReaderUnitTest.testMetadata();
            }
        }
    }

    @Test
    public void testXportMetadata() throws Exception {
        URL resourcesPath = this.getClass().getClassLoader().getResource("");
        if (resourcesPath != null) {
            ...
            for (File currentFile : files) {
                ...
                xportFileReaderTest.testMetadata();
            }
        }
    }
}
